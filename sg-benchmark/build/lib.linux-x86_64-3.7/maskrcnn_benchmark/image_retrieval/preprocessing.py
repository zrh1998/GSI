...
detected_path = './checkpoints/causal_sgdet_ctx_only/inference/VG_stanford_filtered_wth_attribute_test/'
...
vg_data = h5py.File('./vg/VG-SGG-with-attri.h5', 'r')
vg_dict = json.load(open('./vg/VG-SGG-dicts-with-attri.json'))
vg_info = json.load(open('./vg/image_data.json'))
