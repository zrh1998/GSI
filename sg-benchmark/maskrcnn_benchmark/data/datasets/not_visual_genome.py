...
class VGDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, split, img_dir, roidb_file, dict_file, image_file, transforms=None,
                 ...
                 custom_eval=False, custom_path='', stl_train=False, 
                stl_train_label_path='', stl_train_norm=False, stl_eval_zero_out_nan=False, vis_mode=False, mode='predcls', 
                concept_augmented_training=False, cogtree_path='', multi_label_training=False
                 ):
        """
